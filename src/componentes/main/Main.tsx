    ...
    return(
        <>
            ...
            <main className="content-main">
                ...
                imagem="/Barbie.png"/>
                <Filme titulo="Interestelar" sinopse="As reservas naturais da Terra estão chegando ao fim e um grupo 
                de astronautas recebe a missão de verificar possíveis planetas para receberem a população mundial, 
                ...
                Satanás e demônios possuidores de inocentes. Um retrato detalhado de um padre que realizou mais de 100 mil 
                exorcismos em sua vida. Gabriele Amorth (Crowe) é um padre italiano responsável por investigar casos de 
                possessão. Seu trabalho é diretamente organizado pelo Papa (Nero), que conta com a ajuda de Amorth para 
                a resolução de casos inexplicáveis."
                imagem="/OExorcistaDoPapa.png"/>
                <Filme titulo="Velozes & Furiosos 10" sinopse="Dom Toretto e sua família precisam lidar com o adversário 
                mais letal que já enfrentaram. Alimentada pela vingança, uma ameaça terrível emerge das sombras do passado 
                para destruir o mundo de Dom e todos que ele ama. Mas agora, o grupo terá que enfrentar um oponente ainda 
                mais letal vindo do passado e com sede de vingança: Dante Reyes (Jason Momoa), o filho do traficante Hernan 
                Reyes (Joaquim de Almeida), morto no longa Velozes & Furiosos 5, de 2011."
                imagem="/VelozesEFuriosos.jpg"/>
                <Filme titulo="Super Mario Bros. O Filme" sinopse="Mario é um encanador junto com seu irmão Luigi. Um dia, 
                eles vão parar no reino dos cogumelos, governado pela Princesa Peach, mas ameaçado pelo rei dos Koopas, 
                que faz de tudo para conseguir reinar em todos os lugares. Os dois acabam viajando por labirinto subterrâneo 
                e vão parar em um universo paralelo. Enquanto Luigi se vê preso pelo violento Bowser, Mario terá que ajudar 
                uma princesa a salvar seu reino e libertar seu irmão!"
                imagem="/SuperMario.png"/>
            </main>
        </>
    )
